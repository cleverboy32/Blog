<template>
    <div ref="page" class="lion">
        <mouse ref="mouse" />
        <div ref="text" class="text">
            <P v-for="(v, i) in text" :key="i">
                {{ v }}
            </P>
        </div>
        <div ref="lion" class="lions">
            <div class="lion-head">
                <div class="lion-eye left" />
                <div class="lion-eye right" />
                <div class="lion-mouse" />
                <span v-for="(v, i) in head" :key="i" />
            </div>
            <div class="lion-body">
                <span v-for="(v, i) in body" :key="i" />
            </div>
            <div class="lion-foot">
                <span v-for="(v, i) in foot" :key="i" />
            </div>
            <div class="lion-tail">
                <span v-for="(v, i) in tail" :key="i" />
            </div>
        </div>
