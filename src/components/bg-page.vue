<template>
    <div class="bg-page">
        <div class="bg-page__mouse">
            <div class="bg-page__halfmouse top">
                <div class="bg-page__teeth"></div>
                <div class="bg-page__teeth"></div>
                <div class="bg-page__teeth"></div>
                <div class="bg-page__bigteeth"></div>
                <div class="bg-page__lips"></div>
            </div>
            <div class="bg-page__halfmouse bottom">
                <div class="bg-page__teeth"></div>
                <div class="bg-page__teeth"></div>
                <div class="bg-page__teeth"></div>
                <div class="bg-page__bigteeth"></div>
        ...
        <div class="bg-page__teethbrush"></div>
    </div>
</template>
